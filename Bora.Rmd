...
To analyze the long-term behavior of the Bora, we extracted daily records from the Trieste molo F.lli Bandiera station between 2000 and 2024. A day was classified as a "Bora day" if the maximum wind speed reached at least 10 m/s (converted from km/h), and the wind direction was between 45° and 90° from north. These constraints align with the established definition of a typical Bora wind blowing from the northeast.
...
We filtered the dataset to include only rows with valid values for wind speed, wind direction, and temperature. Days were classified as "Bora days" using the same criteria: wind speed of at least 10 m/s and direction between 45° and 90°. The remaining days were considered "non-Bora days."
We then calculated the average daily temperature for both categories. The results showed that the mean temperature on Bora days was noticeably lower than on non-Bora days. This aligns with local expectations, as Bora winds are known to bring cold, dry air from the northeast.
